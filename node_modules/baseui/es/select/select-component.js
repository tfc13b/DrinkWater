...
class Select extends React.Component {
  ...
  filterOptions(excludeOptions) {
    ...
    const filterDoesNotMatchOption = this.props.ignoreCase ? opt => opt[this.props.labelKey].toLowerCase() !== filterValue.toLowerCase().trim() : opt => opt[this.props.labelKey] !== filterValue.trim();
