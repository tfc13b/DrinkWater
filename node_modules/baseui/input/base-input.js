...
var _hide = _interopRequireDefault(require("../icon/hide.js"));

var _show = _interopRequireDefault(require("../icon/show.js"));

var _createEvent = _interopRequireDefault(require("../utils/create-event.js"));
...
var BaseInput = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(BaseInput, [{
    ...
    value: function clearValue() {
      ...
      if (input) {
        var nativeInputValue = Object.getOwnPropertyDescriptor(this.props.type === _constants.CUSTOM_INPUT_TYPE.textarea ? window.HTMLTextAreaElement.prototype : window.HTMLInputElement.prototype, 'value');
