...
var _index = require("../heading/index.js");
...
var SemanticTitle = function SemanticTitle(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_index.LevelContext.Consumer, null, function (level) {
    return /*#__PURE__*/React.createElement(_styledComponents.Title, _extends({
      $as: levels[level]
    }, restProps), children);
  });
};
